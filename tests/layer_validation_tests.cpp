...
TEST_F(VkLayerTest, RenderPassInitialLayoutUndefined) {
    TEST_DESCRIPTION("Ensure that CmdBeginRenderPass with an attachment's initialLayout"
                     "of VK_IMAGE_LAYOUT_UNDEFINED works when the command buffer has "
                     "prior knowledge of that attachment's layout.");
...
TEST_F(VkLayerTest, RenderPassSubpassZeroTransitionsApplied) {
    ...
    VkSubpassDependency dep = {
        0, 0, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT,
